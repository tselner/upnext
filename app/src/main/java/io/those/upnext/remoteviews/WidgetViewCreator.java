...
public class WidgetViewCreator {
    public static RemoteViews createWidgetView(Context context, int appWidgetId) {
        ...
        LocalDate today = LocalDate.of(2021, Month.NOVEMBER, 15);
    ...
    private static Intent createServiceIntent(Context context, int appWidgetId, LocalDate start, LocalDate end, boolean withDayLabels) {
